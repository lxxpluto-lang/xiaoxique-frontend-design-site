...
- 已将首页重构为“今日 1 个核心任务 + 1 个主按钮”，并展示推荐依据与完成后的报告去向。
- 已将小喜从空白聊天入口升级为任务型助手：今天怎么练、数值怎么了、报告怎么看、计划要调整吗。
- 健康数据拆分为今日、趋势、计划、记录四层；健康档案增加可检查的阶段目标和数据来源。
- 健康积分增加 7/30/60/100 天里程碑，明确中断不扣分、营销任务不计入健康积分。

迁移范围、Stage 0 处置和浏览器验收记录见 [`docs/SHANBAY-MIGRATION-20260901.md`](docs/SHANBAY-MIGRATION-20260901.md)。
